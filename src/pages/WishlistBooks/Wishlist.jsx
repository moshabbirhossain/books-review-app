                    ...
                    <div key={wishlist.id} className="hero">
                        <div className="w-full hero-content items-start flex-col lg:flex-row  lg:items-stretch lg:justify-between lg:gap-x-12 border rounded-lg shadow-sm">
                            <div className="w-1/4 bg-base-200 border-2 rounded-lg p-6">
                                <img src={wishlist.image} alt="" className="w-32 h-40 mx-auto"/>
                            </div>
                            <div className="w-3/4">
                                ...
                                <div className='flex items-center gap-x-3'>
                                    <div className="tracking-widest flex flex-row items-center gap-3">
                                        ...
                                        {
                                            wishlist.tags.map((tag)=>(  <span key={tag}className="text-base text-nowrap font-bold px-4 py-0 border bg-gray-100 rounded-full text-[#23be0a]">
                                                #{tag}</span>))
                                        }
                                    </div>
                                    <div className='flex items-center gap-x-2 my-3'>
                                        <RiMapPinLine/>
                                        <p className="text-start text-base font-medium">Year of Publishing: {wishlist.yearOfPublishing}</p>
                                    </div>
                                </div>
